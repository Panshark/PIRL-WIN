...
from model import RL_Policy2, Local_IL_Policy, Neural_SLAM_Module
...
def Reward_function_april15_blue(
                    prev_loc, # last step agent loc
                    map_goal, # target loc
                    prev_blue_point_loc) :# last step GL angle 
    ...
    reward = - delta_dist_blue2goal + dist_reward
...
def main():
    ...
    # Global policy
    g_policy = RL_Policy2(g_observation_space.shape, g_action_space, model_type=1,
    ...
    prev_blue_point_loc = [global_goals[0][1] + o0, global_goals[0][0] + o1]
    ...
    for ep_num in range(num_episodes):
        ...
        for step in range(args.max_episode_length):
            ...
            if l_step == args.num_local_steps - 1:
                ...
                temp_reward = Reward_function_april15_blue(
