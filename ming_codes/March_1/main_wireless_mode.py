...
def Load_wireless_data(dir):
    csv_data = pd.read_csv(dir)
    csv_data = data_scaler(csv_data)

    return csv_data

def Load_wireless_goal(dir, tx_idx):
    tx_locs = pd.read_csv(dir)
    
    tx_idx_int = int(tx_idx) - 1
...
def main():
    ...
    map_data_name = "{}data/".format(args.map_location)
    map_goal_name = "{}goal/".format(args.map_location)
    
    tx_num = '7'
    columns = ['aoaAzResult_1','aoaAzResult_2','aoaAzResult_3',
        'aoaAzResult_4','aoaAzResult_5','aodAzResult_1',
        'aodAzResult_2','aodAzResult_3','aodAzResult_4',
        'aodAzResult_5','snrResult_1','snrResult_2',
        'snrResult_3','snrResult_4','snrResult_5']
    
    map_data = Load_wireless_data(map_data_name+"Adrian_Tx_"+ tx_num +"_beam_search.csv")
    map_goal = Load_wireless_goal(map_goal_name+"Adrian_tx_pos.csv", tx_num)
        ...
        for step in range(args.max_episode_length):
            ...
            if l_step == args.num_local_steps - 1:
                ...
                try:
                    ...
                    print("ERROR: The shape of global_input_wireless is not suitable when storage, shape is:", global_input_wireless.shape)
