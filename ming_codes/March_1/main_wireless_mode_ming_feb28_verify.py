    ...
    for ep_num in range(num_episodes):
        for step in range(args.max_episode_length):
            ...
            if l_step == args.num_local_steps - 1:
                ...
                """
                Ming Feb 28
                Verify if the data load is correct
                Set the gobal goal to the AoA direction
                """
                for e, action in enumerate(cpu_actions):
                    ...
                    o1 = o1/0.05
                    # Get data here:
                    temp_np = global_input_wireless.detach().numpy()
                    aoa2 = temp_np[0] * 180 # degree
                    print(f"Log : AoA is {aoa2}")
