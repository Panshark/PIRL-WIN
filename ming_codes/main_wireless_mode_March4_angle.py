...
def read_wireless_measure(map_data, curr_cln, curr_row, 
    ...
    print(f'Log: Current SNR {round(wireless_obs[-1].item(), 2)}, Angle {wireless_obs[0 + 16].item()}, LS {link_state}')
...
def main():
    ...
    assert global_input_wireless.shape == torch.Size([32]), "Wrong wirelss data"
    #
