...
def Reward_funciton_new(curr_loc,
                        map_goal,
        obs, policy_output_ang, prev_link_state, link_state, max_power, k = 1, gamma=2):
    ...
    reward += k*minus_power_reward + dist_reward + gamma*angle_reward + link_punish

    logging.info(f"Log: power {minus_power_reward}; dist {dist_reward}; angle {angle_reward}; link_punish {link_punish} rewards")
