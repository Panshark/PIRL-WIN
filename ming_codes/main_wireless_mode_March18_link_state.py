...
def Reward_function_march18_Ming(curr_loc,
    ...
    reward += alpha * angle_reward + beta * dist_reward + gamma * minus_power + link_state_diff
        ...
        for step in range(args.max_episode_length):
            ...
            if l_step == args.num_local_steps - 1:
                ...
                if global_goals[0][1] >= 0.5:
                    ...
                    global_goals[0][1] = 0.7 * args.walking_distance # walking distance
                ...
                temp_reward = Reward_function_march18_Ming(
                    [x_gc_prev, y_gc_prev],
