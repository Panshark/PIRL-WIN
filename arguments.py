...
def get_args():
    ...
    parser.add_argument('--num_processes_on_first_gpu', type=int, default=2)
    ...
    parser.add_argument('--save_interval', type=int, default=1,
                        help="""save interval""")
    parser.add_argument('-map', '--map_location', type=str, default="./data/wireless_direction_demo/",
                        help='path to load wireless map (default: ./data/wireless_direction_demo/)')
    ...
    parser.add_argument('-fh', '--frame_height', type=int, default=128,
                        help='Frame height (default:84)')
    parser.add_argument('-el', '--max_episode_length', type=int, default=30,
    ...
    parser.add_argument('--global_lr', type=float, default=2.5e-4,
                        help='global learning rate (default: 2.5e-4)')
    parser.add_argument('--global_hidden_size', type=int, default=12,
    ...
    # Ming ????
    # why A2C step is 40 but in the comment it is (default: 5)
    parser.add_argument('--num_global_steps', type=int, default=12,
                        help='number of forward steps in A2C (default: 5)')
    parser.add_argument('--ppo_epoch', type=int, default=4,
                        help='number of ppo epochs (default: 4)')
    parser.add_argument('--num_mini_batch', type=str, default="1",
    ...
    # Y2L
    parser.add_argument('--walking_distance', type=float, default=60.0,
                        help="global walking distance (default: 60.0)")
    parser.add_argument('--warm_up_episode', type=int, default=10,
    ...
    if args.num_mini_batch == "auto":
        ...
        # print("args.num_processes",args.num_processes,"args.num_mini_batch",args.num_mini_batch)
    else:
